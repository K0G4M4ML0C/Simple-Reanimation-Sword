...
sick.SoundId = "rbxassetid://1213124438"
sick.Looped = true
sick.Pitch = 1
sick.Volume = 1
sick:Play()
...
local function align(part0, part1)
        ...
        attachment0.Position = Vector3.new(0, 2, -2.5)
        attachment0.Orientation = Vector3.new(-140, 0, 0)
    ...
    align(hat.Handle, HandlePart)


--[[local c = game.Players.LocalPlayer.Character["DemonGodSword"].Handle
...
game:GetService("RunService").RenderStepped:Connect(function(dt)
	cRot = cRot + -5*dt
	c.Anchored = true
	c.CFrame = HandlePart.CFrame * CFrame.new(0,0,-3.5) * CFrame.Angles(2.45,0,0)
...
local part = CreatePart(3, Weapon, "Neon", 0, 0, "Alder", "Handle", VT(0.05,8,1.5),false)
MakeForm(part,"Wedge")
...
local part = CreatePart(3, Weapon, "Neon", 0, 0, "Alder", "Handle", VT(0.18,0.6,0.18),false)
MakeForm(part,"Cyl")
CreateWeldOrSnapOrMotor("Weld", Handle, Handle, part, CF(0, -1.2, 0) * ANGLES(RAD(0), RAD(0), RAD(0)), CF(0, 0, 0))

	for i = 1, 5 do
		local RingPiece = CreatePart(3, Weapon, "Neon", 0, 0, "Alder", "ClawPart", VT(0.3,0.08,0.2),false)
...
local part = CreatePart(3, Weapon, "Neon", 0, 0, "Alder", "Handle", VT(0.5,0.2,0.5),false)
MakeForm(part,"Cyl")
...
Trail.Attachment1 = B
Trail.Lifetime = 0.2
Trail.Color = ColorSequence.new(BRICKC"Alder".Color)
...
local SKILL1TEXT = CreateLabel(SKILL1FRAME, "[Z] Alder Combo", SKILLTEXTCOLOR, 8, "Garamond", 0, 2, 1, "Text 1")
local SKILL2TEXT = CreateLabel(SKILL2FRAME, "[B] Alder Field", SKILLTEXTCOLOR, 8, "Garamond", 0, 2, 1, "Text 2")
local SKILL3TEXT = CreateLabel(SKILL3FRAME, "[C] Cursed Cutter", SKILLTEXTCOLOR, 8, "Garamond", 0, 2, 1, "Text 3")
...
function AlderCombo()
	...
	for i=0, 0.3, 0.1 / Animation_Speed do
		...
		RightShoulder.C0 = Clerp(RightShoulder.C0, CF(1.5, 0.5, 0) * ANGLES(RAD(30), RAD(0), RAD(75)) * RIGHTSHOULDERC0, 0.8)
	...
	for i=0, 0.3, 0.1 / Animation_Speed do
		Swait()
		RootJoint.C0 = Clerp(RootJoint.C0,ROOTC0 * CF(0, 0, 0 + 0.05 * COS(SINE / 12)) * ANGLES(RAD(0), RAD(0), RAD(-55)), 0.2)
		Neck.C0 = Clerp(Neck.C0, NECKC0 * CF(0, 0, 0 + ((1) - 1)) * ANGLES(RAD(0 - 2.5 * SIN(SINE / 12)), RAD(0), RAD(55)), 0.2)
		RightShoulder.C0 = Clerp(RightShoulder.C0, CF(1.5, 0.5, 0) * ANGLES(RAD(0), RAD(90), RAD(90)) * RIGHTSHOULDERC0, 0.2)
		LeftShoulder.C0 = Clerp(LeftShoulder.C0, CF(-1.5, 0.5, 0) * ANGLES(RAD(90), RAD(0), RAD(-12)) * LEFTSHOULDERC0, 0.2)
		RightHip.C0 = Clerp(RightHip.C0, CF(1, -1 - 0.05 * COS(SINE / 12), -0.01) * ANGLES(RAD(0), RAD(90), RAD(0)) * ANGLES(RAD(-8), RAD(0), RAD(0)), 0.2)
		LeftHip.C0 = Clerp(LeftHip.C0, CF(-1, -1 - 0.05 * COS(SINE / 12), -0.01) * ANGLES(RAD(0), RAD(-90), RAD(0)) * ANGLES(RAD(-8), RAD(0), RAD(0)), 0.2)
		HandleWeld.C0 = Clerp(HandleWeld.C0, CF(0, -1, -0.35) * ANGLES(RAD(0), RAD(0), RAD(0)), 0.2 / Animation_Speed)
	end
	CreateSound("588693156", Handle, 2, 1)

	for i=0, 0.3, 0.1 / Animation_Speed do
		Swait()
		RootJoint.C0 = Clerp(RootJoint.C0,ROOTC0 * CF(0, 0, 0 + 0.05 * COS(SINE / 12)) * ANGLES(RAD(0), RAD(0), RAD(90)), 1)
		Neck.C0 = Clerp(Neck.C0, NECKC0 * CF(0, 0, 0 + ((1) - 1)) * ANGLES(RAD(0 - 2.5 * SIN(SINE / 12)), RAD(0), RAD(-90)), 0.9)
		RightShoulder.C0 = Clerp(RightShoulder.C0, CF(1.5, 0.5, 0) * ANGLES(RAD(90), RAD(0), RAD(90)) * RIGHTSHOULDERC0, 1)
		LeftShoulder.C0 = Clerp(LeftShoulder.C0, CF(-1.5, 0.5, 0) * ANGLES(RAD(90), RAD(0), RAD(-12)) * LEFTSHOULDERC0, 1)
		RightHip.C0 = Clerp(RightHip.C0, CF(1, -1 - 0.05 * COS(SINE / 12), -0.01) * ANGLES(RAD(0), RAD(90), RAD(0)) * ANGLES(RAD(-8), RAD(0), RAD(0)), 1)
		LeftHip.C0 = Clerp(LeftHip.C0, CF(-1, -1 - 0.05 * COS(SINE / 12), -0.01) * ANGLES(RAD(0), RAD(-90), RAD(0)) * ANGLES(RAD(-8), RAD(0), RAD(0)), 1)
		HandleWeld.C0 = Clerp(HandleWeld.C0, CF(0, -1, -0.35) * ANGLES(RAD(-90), RAD(0), RAD(0)), 1)
	end
	Trail.Enabled = false
	ATTACK = false
	Rooted = false
